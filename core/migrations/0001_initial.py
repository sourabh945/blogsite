    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='author', to='core.user', verbose_name='author username')),
            ],
        ),
        migrations.CreateModel(
            name='ValidationIDs',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid5, primary_key=True, serialize=False, unique=True, verbose_name='verification code')),
